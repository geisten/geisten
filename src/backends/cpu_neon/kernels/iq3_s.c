...
static inline void iq3s_subblock_to_int8(int8_t out[32],
    ...
    for (int l = 0; l < 4; l++) {
        const uint32_t idx1 = (uint32_t)qs_lo[2*l + 0] |
                                ((uint32_t)(qh << (8 - 2*l)) & 256);
        const uint32_t idx2 = (uint32_t)qs_lo[2*l + 1] |
...
#else
    (void)x_q8; (void)scale_x; (void)w_iq3s; (void)n_in; (void)n_out; (void)y;
...
void linear_iq3s_w3a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
    ...
    (void)w_iq3s; (void)n_in; (void)n_out; (void)y;
...
#else
    (void)x_q8; (void)scale_x; (void)w_iq3s_blocks; (void)w_flat;
...
#else
    (void)x_q8; (void)scale_x; (void)m; (void)w_iq3s_blocks; (void)w_flat;
    (void)n_in; (void)n_out; (void)y;
...
void linear_iq3s_flat_w3a8_prefill(const float* x, const void* w_iq3s_blocks,
    ...
    linear_iq3s_flat_w3a8_prefill_pre(x_q8, scale_x, m, w_iq3s_blocks,
                                       w_flat, n_in, n_out, y);
    safe_free((void **) &x_q8); safe_free((void **) &scale_x);
}
