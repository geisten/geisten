...
struct geist_weight;
[[nodiscard]] enum geist_status cpu_scalar_resolve_weight(
    struct geist_backend *be, struct geist_weight *w);

/* Element-wise + rmsnorm ops — F32 DENSE on all inputs/outputs. */
[[nodiscard]] enum geist_status cpu_scalar_add(
    struct geist_backend *be, const struct geist_tensor *a, const struct geist_tensor *b,
    struct geist_tensor *y);
[[nodiscard]] enum geist_status cpu_scalar_mul(
    struct geist_backend *be, const struct geist_tensor *a, const struct geist_tensor *b,
    struct geist_tensor *y);
[[nodiscard]] enum geist_status cpu_scalar_gelu_tanh(
...
[[nodiscard]] enum geist_status cpu_scalar_relu_squared(
    struct geist_backend *be, const struct geist_tensor *x, struct geist_tensor *y);
[[nodiscard]] enum geist_status cpu_scalar_silu(
    struct geist_backend *be, const struct geist_tensor *x, struct geist_tensor *y);
[[nodiscard]] enum geist_status cpu_scalar_rmsnorm(
