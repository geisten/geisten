...
const char* gguf_get_meta_string(const struct gguf_ctx* ctx, const char* key,
                                  size_t* out_len);
bool        gguf_get_meta_u32(const struct gguf_ctx* ctx, const char* key,
                               uint32_t* out);
bool        gguf_get_meta_u64(const struct gguf_ctx* ctx, const char* key,
                               uint64_t* out);
bool        gguf_get_meta_f32(const struct gguf_ctx* ctx, const char* key,
                               float* out);
bool        gguf_get_meta_bool(const struct gguf_ctx* ctx, const char* key,
                                bool* out);
