...
void linear_iq2s_decode_w2a8(const float* x, const void* w_iq2s,
                              size_t n_in, size_t n_out, float* y);
void linear_iq2s_decode_w2a8_pre(const int8_t* x_q8, float scale_x,
                                  const void* w_iq2s, size_t n_in, size_t n_out,
                                  float* y);
...
void linear_iq3s_decode_w3a8(const float* x, const void* w_iq3s,
                              size_t n_in, size_t n_out, float* y);
void linear_iq3s_decode_w3a8_pre(const int8_t* x_q8, float scale_x,
                                  const void* w_iq3s, size_t n_in, size_t n_out,
                                  float* y);
...
void linear_iq2s_w2a8_prefill(const float* x, const void* w_iq2s, size_t m,
                               size_t n_in, size_t n_out, float* y);
void linear_iq2s_w2a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                    size_t m, const void* w_iq2s,
                                    size_t n_in, size_t n_out, float* y);
...
void linear_iq3s_w3a8_prefill(const float* x, const void* w_iq3s, size_t m,
                               size_t n_in, size_t n_out, float* y);
void linear_iq3s_w3a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                    size_t m, const void* w_iq3s,
                                    size_t n_in, size_t n_out, float* y);
...
void linear_iq2s_flat_w2a8(const float* x, const void* w_iq2s_blocks,
                            const int8_t* w_flat,
                            size_t n_in, size_t n_out, float* y);
void linear_iq2s_flat_w2a8_pre(const int8_t* x_q8, float scale_x,
                                const void* w_iq2s_blocks,
                                const int8_t* w_flat,
                                size_t n_in, size_t n_out, float* y);
void linear_iq3s_flat_w3a8(const float* x, const void* w_iq3s_blocks,
                            const int8_t* w_flat,
                            size_t n_in, size_t n_out, float* y);
void linear_iq3s_flat_w3a8_pre(const int8_t* x_q8, float scale_x,
...
void linear_iq2s_flat_w2a8_prefill(const float* x, const void* w_iq2s_blocks,
                                    const int8_t* w_flat, size_t m,
                                    size_t n_in, size_t n_out, float* y);
void linear_iq2s_flat_w2a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                        size_t m, const void* w_iq2s_blocks,
                                        const int8_t* w_flat,
                                        size_t n_in, size_t n_out, float* y);
void linear_iq3s_flat_w3a8_prefill(const float* x, const void* w_iq3s_blocks,
                                    const int8_t* w_flat, size_t m,
                                    size_t n_in, size_t n_out, float* y);
void linear_iq3s_flat_w3a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                        size_t m, const void* w_iq3s_blocks,
                                        const int8_t* w_flat,
                                        size_t n_in, size_t n_out, float* y);
...
bool gguf_dequant_row_to_fp32(const struct gguf_tensor_t* t, size_t row_idx,
                               size_t row_elems, float* out);
...
void linear_q5k_decode_w5a8(const float* x, const void* w_q5k,
                             size_t n_in, size_t n_out, float* y);
void linear_q5k_decode_w5a8_pre(const int8_t* x_q8, float scale_x,
                                  const int32_t* sum32,
                                  const void* w_q5k, size_t n_in, size_t n_out,
                                  float* y);
void linear_q5k_w5a8_prefill(const float* x, const void* w_q5k, size_t m,
                              size_t n_in, size_t n_out, float* y);
void linear_q5k_w5a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                   const int32_t* sum32, size_t m,
                                   const void* w_q5k, size_t n_in, size_t n_out,
                                   float* y);
...
int q6k_x8_gemv_pack(const void* w_q6k, size_t n_in, size_t n_out,
                     void* dst);
...
void linear_q3k_decode_w3a8(const float* x, const void* w_q3k,
                             size_t n_in, size_t n_out, float* y);
void linear_q3k_decode_w3a8_pre(const int8_t* x_q8, float scale_x,
                                 const void* w_q3k, size_t n_in, size_t n_out,
                                 float* y);
...
void linear_q3k_w3a8_prefill(const float* x, const void* w_q3k, size_t m,
                              size_t n_in, size_t n_out, float* y);
void linear_q3k_w3a8_prefill_pre(const int8_t* x_q8, const float* scale_x, size_t m,
                                   const void* w_q3k, size_t n_in, size_t n_out,
                                   float* y);
...
void linear_q8_0_decode_w8a8(const float* x, const void* w_q8,
                              size_t n_in, size_t n_out, float* y);
...
void linear_q8_0_w8a8_prefill(const float* x, const void* w_q8, size_t m,
                                size_t n_in, size_t n_out, float* y);
void linear_q8_0_w8a8_prefill_pre(const int8_t* x_q8, const float* scale_x,
                                    size_t m, const void* w_q8,
                                    size_t n_in, size_t n_out, float* y);

void linear_q8_0_decode_w8a8_pre(const int8_t* x_q8, float scale_x,
                                  const void* w_q8, size_t n_in, size_t n_out,
                                  float* y);
